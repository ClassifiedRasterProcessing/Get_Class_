...
User_Field_Value= arcpy.GetParameterAsText(8)	       # column name for the classifications
...
Parameters = Frame.classifiedRaster(input1,X,Y,Ratio,User_Class, User_Field_Value)
